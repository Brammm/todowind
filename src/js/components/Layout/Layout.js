...
const Layout = ({children, header}) => {
    ...
    let navClassName = 'w-full fixed z-50 lg:w-1/4 xl:w-1/5 bg-gray-800 text-gray-100 lg:block h-screen shadow-2xl';
    if (! showNavigation) {
    ...
    return (
        <>
            <header className="fixed w-full z-40 flex flex-justify-between h-16 bg-gray-800 text-gray-100 items-center shadow-l">
